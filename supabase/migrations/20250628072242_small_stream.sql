...
-- Create ingestion_documents_new table
...
-- Create TF_key_value_pair table
...
-- Insert default regular user (password is 'password')
INSERT INTO users (email, name, password, role) 
...
PRINT '';
PRINT 'Database setup complete! You can now start the application.';